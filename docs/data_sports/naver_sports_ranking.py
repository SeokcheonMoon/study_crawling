...
mongoClient = MongoClient("mongodb://192.168.10.240:27017/") # mongoDB 주소
database = mongoClient[""] # database 이름
collection = database[''] # collection 이름
...
pass
browser.get("https://sports.news.naver.com/ranking/index.nhn?type=popular")                                     # - 주소 입력
